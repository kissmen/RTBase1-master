...
int main(int argc, char *argv[])
{
	...
	//string sceneName = "cornell-box";
	string sceneName = "MaterialsScene/MaterialsScene";
	//string sceneName = "Scenes1/bathroom";
	//string sceneName = "Scenes1/bathroom2";
	//string sceneName = "Scenes1/house";
	//string sceneName = "Scenes1/kitchen";
	string filename = "GI.hdr";
